...
class Book:
    ...
    def __str__(self):
        return (
            f"Book in Library: {self.library}\nPublication Date: {self.publication_date}\nAuthor: {self.author_name} "
...
class Order:
    ...
    def __str__(self):
        ...
        return (
            f"Order by {self.employee.first_name} {self.employee.last_name} for student {self.student}\n"
            f"Ordered books:\n{book_list}\nOrder Date: {self.order_date}\n"
        )


library1 = Library(
    "New York", "Main Street", "10001", "9:00 AM - 5:00 PM", "+1-123-456-7890"
)
library2 = Library(
    "Los Angeles", "Broadway", "90001", "10:00 AM - 6:00 PM", "+1-987-654-3210"
)
