...
class Tom:
    def __init__(self):
        self.dane = pd.DataFrame({'Miesiąc': ["Styczeń","Luty","Marzec","Kwiecień","Maj","Czerwiec","Lipiec",,"Luty","Marzec","Kwiecień","Maj","Czerwiec","Lipiec","S,"Luty","Marzec","Kwiecień","Maj","Czerwiec","Lipiec","S"Sierpień","Wrzesień","Październik","Listopad","Grudzień"],
                                  'SmartTV': [159,187,245,151,181,160,142,217,152,143,157,175],
                                  'TV': [159,187,246,151,181,150,134,149,131,105,129,142]})
        self.abbreviated_months = ["Sty","Lut","Mar","Kwi","Maj","Cze","Lip","Sie","Wrz","Paź","Lis","Gru"]
    ...
    def plot_sales(self):
        ...
        plt.xticks(range(len(self.dane)), self.abbreviated_months)  # Use abbreviated month names for x-axis labels
        plt.ylim(0, self.dane.max().max())  # Set y-axis limit
        plt.show()
